        ...
        <div className="w-full h-auto flex flex-col my-2 space-y-1">
            <div className="w-full h-8 flex flex-row">
                ...
                <div className="w-3/4 flex justify-start items-center" >
                    <h1 className="text-md text-blue-300">Include Uppercase Letters</h1>
                </div>
            </div>
            ...
            <div className="w-full h-8 flex flex-row">
                ...
                <div className="w-3/4 flex justify-start items-center" >
                    <h1 className="text-md text-yellow-300">Include Lowerercase Letters</h1>
                </div>
            </div>
            ...
            <div className="w-full h-8 flex flex-row">
                ...
                <div className="w-3/4 flex justify-start items-center" >
                    <h1 className="text-md text-red-300">Include Numbers</h1>
                </div>
            </div>
            ...
            <div className="w-full h-8 flex flex-row">
                ...
                <div className="w-3/4 flex justify-start items-center" >
                    <h1 className="text-md text-orange-300">Include Symbols</h1>
                </div>
            </div>
        </div>
    );
